CREATE DATABASE IF NOT EXISTS tornado1 default charset utf8 COLLATE utf8_general_ci;
CREATE USER 'tornado1'@'%' IDENTIFIED BY '123456';
GRANT ALL ON tornado1.* to 'tornado1'@'%' WITH GRANT OPTION;
drop user 'tornado1'@'%';
flush privileges;
...
CREATE TABLE ih_user_profile (
    ...
    up_utime datetime  DEFAULT null COMMENT '最后更新时间',
    up_ctime datetime  DEFAULT null COMMENT '创建时间',
...
CREATE TABLE ih_area_info (
    ...
    ai_name varchar(32)  COMMENT '区域名称',
    ai_ctime datetime  COMMENT '创建时间',
...
CREATE TABLE ih_house_info (
    ...
    hi_utime datetime COMMENT '最后更新时间',
    hi_ctime datetime COMMENT '创建时间',
...
CREATE TABLE ih_house_facility (
    ...
    hf_ctime datetime  COMMENT '创建时间',
    PRIMARY KEY (hf_id),
...
CREATE TABLE ih_facility_catelog (
    ...
    fc_ctime datetime  COMMENT '创建时间',
    PRIMARY KEY (fc_id)
...
CREATE TABLE ih_order_info (
    ...
    oi_utime datetime  COMMENT '最后更新时间',
    oi_ctime datetime  COMMENT '创建时间',
